...
test("production build emits one content-addressed frontend module graph", async () => {
  ...
  for (const name of ["auto_generation_sync", "thumbnails", "generation_submissions", "app", "api", "lib", "render", "gallery_hover", "gallery_groups", "gallery_selection", "server_clock", "generation_countdown", "lora_stack", "user_settings"]) {
