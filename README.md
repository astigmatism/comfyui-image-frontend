...
On Samus (`192.168.1.5`), start with that guide's **Start here** section and the
copyable [production update prompt](docs/production-update-prompt.md). Read the
guide from the fetched target commit, not the deliberately frozen `source/main`.
