...
PUBLICATION_ROWS = [
    ...
    ("07", "Artifact identity uses hashes of exact raw bytes", "raw-byte SHA-256 validation in `domain/publication.py`", "workflow/API corruption and manifest revision fixtures"),
    ...
    ("18", "Matching editable workflow metadata is attached when declared", "publication runtime snapshot and `queue_worker.py` prompt `extra_data`", "submission payload tests"),
