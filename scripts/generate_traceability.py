...
def render() -> str:
    ...
    lines.extend(
        [
            ...
            "editor can send `think: false` for an individual composition. The adapter first "
            "accepts a schema-constrained final object from `response`, falls back to one in "
            "`thinking`, and treats absent thinking as a capability warning when the response "
