...
def render() -> str:
    ...
    lines.extend(
        [
            ...
            "temperature, and candidate seed. Transient generate failures receive an independent "
            "bounded retry. Automatic composition failures receive bounded browser backoff and "
