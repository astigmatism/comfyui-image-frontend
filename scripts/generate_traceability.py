...
def render() -> str:
    ...
    lines = [
        ...
        "by the publication acceptance matrix that follows; Ollama model-selection and "
        "queued-cancellation language are superseded by the current overrides below. Run `python3 "
