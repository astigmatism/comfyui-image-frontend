...
- `OllamaAdapter`: router availability validation, model-free thinking-enabled structured composition, safe final-prompt extraction, and effective-model provenance.
